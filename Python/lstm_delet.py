...
data_images = data_images.reshape(22796,1,15)

odel = Sequential() 
model.add(LSTM(units = 256, input_shape=(1,15), activation='sigmoid',return_sequences=True))
